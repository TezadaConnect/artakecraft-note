      ...
      <section className="mt-14 text-slate-400">
        <div className="text-center p-4 flex items-center flex-col">
          ...
          <p className="mt-6 mx-6 xl:w-2/4 lg:w-3/4 font-light">
            The <span className="font-semibold">Artakecraft Note Project</span> was designed with novelists in mind. I aspire to produce simple
            writing notes for everyone who writes. I guarantee that you will adore this program, regardless of your skill level. level—professional or
            novice.
          </p>
          ...
          <p className="mt-6 mx-6 xl:w-2/4 lg:w-3/4 font-light">
            ...
            <span className="font-semibold">character profiling</span>, and <span className="font-semibold">scene note-taking.</span> In future
            updates, I foresee myself implementing an AI program to boost writers productivity.
          </p>
